<template>
  <div class="project-screen">
     <a href="https://www.nicholsonmcbride.com/digital-transformation" target="_blank" class="project-screen__link">
        <g-image :immediate="true" src="~/assets/images/websites/digital-transformation.png" width="555" alt="Nicholson McBride Digital Transformation - Built at Cursor" />
    </a>
...
@Component
export default class NicholsonMcBride extends Vue {
