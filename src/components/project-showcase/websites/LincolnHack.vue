<template>
  <div class="project-screen">
    <a href="https://2018.lincolnhack.org/" target="_blank" class="project-screen__link">
      <g-image :immediate="true" src="~/assets/images/websites/lincoln-hack.png"  width="750" alt="Lincoln Hack 2018 website - Built at Cursor" />
    </a>
...
@Component
export default class LincolnHack extends Vue {
