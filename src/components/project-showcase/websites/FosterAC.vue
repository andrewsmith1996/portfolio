<template>
  <div class="project-screen">
    <a href="https://www.fosterac.co.uk/" target="_blank" class="project-screen__link">
      <g-image :immediate="true" src="~/assets/images/websites/fosterac.png" width="555" alt="Foster Environmental - Built at Cursor" />
  </a>
...
@Component
export default class FosterAC extends Vue {
