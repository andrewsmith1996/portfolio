<template>
  <div class="project-screen">
    <a href="https://www.espressodesign.co.uk/offers" target="_blank" class="project-screen__link">
       <g-image :immediate="true" src="~/assets/images/websites/espresso-design.png" width="555" alt="Espresso Design Offers Page - Built at Cursor" />
    </a>
...
@Component
export default class EspressoDesign extends Vue {
