<template>
   <div class="project__simple">
        ...
        <div class="project__simple-screenshots">
            <g-image :immediate="true" src="~/assets/images/apps/hoptical-one.png" width="263" class="project__simple-screenshot" alt="Hoptical Craft Beer Tracking app built in Android" />
            <g-image :immediate="true" src="~/assets/images/apps/hoptical-three.png" width="263" class="project__simple-screenshot" alt="Hoptical Craft Beer Tracking app built in Android" />
            <g-image :immediate="true" src="~/assets/images/apps/hoptical-two.png" width="263" class="project__simple-screenshot" alt="Hoptical Craft Beer Tracking app built in Android" />
        </div>
    </div>
</template>
