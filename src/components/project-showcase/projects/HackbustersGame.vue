<template>
  <div class="flex flex-col lg:flex-row">
    <div class="flex flex-col w-full lg:w-1/2">
      <ProjectTitle title="Hackbusters - Lincoln Hack 2018" githubLink="https://github.com/andrewsmith1996/hackbusters-game-lincoln-hack-2018" />
      ...
      <ViewGitHub githubLink="https://github.com/andrewsmith1996/hackbusters-game-lincoln-hack-2018" />
      <ProjectTecnologies class="mb-6" :technologies="['node', 'express', 'socketio', 'jquery']" />
      </div>
      <div class="w-full lg:w-1/2 items-center">
        <img class="px-4" src="../../../assets/images/apps/hackbusters.png" alt="Socket.IO, Node.js and Express interactive Dambusters Game" />
      </div>
  </div>
</template>
