...
<template>
  <div class="project__simple">
    ...
    <div class="project__simple-screenshots">
        <g-image :immediate="true" src="~/assets/images/apps/image-recognition-react-native-1.png" width="263" class="project__simple-screenshot" alt="React Native image recognition app" />
        <g-image :immediate="true" src="~/assets/images/apps/image-recognition-react-native-2.png" width="263" class="project__simple-screenshot" alt="React Native image recognition app" />
        <g-image :immediate="true" src="~/assets/images/apps/image-recognition-react-native-3.png" width="263" class="project__simple-screenshot" alt="React Native image recognition app" />
    </div>
  </div>
</template>
