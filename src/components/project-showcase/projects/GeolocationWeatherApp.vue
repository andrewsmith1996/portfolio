<template>
 <div class="project__simple">
    ...
    <div class="project__simple-screenshots">
        <g-image :immediate="true" src="~/assets/images/apps/geolocation-one.png" width="263" class="project__simple-screenshot" alt="React Native Geolocation Weather Forecast app" />
        <g-image :immediate="true" src="~/assets/images/apps/geolocation-two.png" width="263" class="project__simple-screenshot" alt="React Native Geolocation Weather Forecast app" />
    </div>
  </div>
</template>
